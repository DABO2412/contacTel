    ...
    function onDeviceReady() {
        ...
        document.querySelector("#btn-add").addEventListener("click", createContact);
    ...
    function findContact(){
        ...
        let fields  = ['*'];
        navigator.contacts.find(fields, afficheContact, onContactError, option);
    }
    
    function afficheContact(contacts){
        listHtml = "";
        ...
        navigator.contacts.find(fields, function(contacts) {
            ...
            if (contact) {
                ...
                contact.save(function() {
                    ...
                    homePage(); // Rafraîchit la liste des contacts après la mise à jour
                }, onContactError);            
            } else {
